    ...
    return (
        <div className={classes.grid}>
            <div className={classes.avatar}>
                <div className={classes.avatarText}>{localStorage.getItem('username').charAt(0)}</div>
            </div>
            { newCommentHandler ? 
            <div>
                ...
                <div className={classes.controls}>
                    <button onClick={closeNewCommentModal} className='alt'>Cancel</button>
                    <button onClick={submitCommentHandler} className='btn'>Send</button>
                </div>
            </div>
                : 
