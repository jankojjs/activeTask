            ...
            <div className={classes.commentPart}>
                <div className={classes.commentTop}>
                    <div className={classes.text}>
                        <span className={classes.name}>{singleComment.firstname} {singleComment.lastname.charAt(0)}.</span>
                    ...
                    <div className={classes.controls}>
                        <span className={classes.editIcon} onClick={openEditModalHandler}><RiEdit2Line /></span>
                        <span className={classes.deleteIcon} onClick={openDeleteModalHandler}><RiDeleteBin5Line /></span>
                    </div>
                    }
                </div>
                { editModalHandler ? <EditComment onSuccess={props.changes} cid={singleComment.cid} initState={singleComment.comment_desc} onCancel={closeEditModalHandler} /> : <div className={classes.description} dangerouslySetInnerHTML={{ __html: singleComment.comment_desc }}></div> }
            </div>
