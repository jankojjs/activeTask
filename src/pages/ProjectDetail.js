...
function ProjectDetailPage() {
  ...
  function fetchData() {
    fetch(
      "https://jjsolutions.rs/api/singleprojectapi.php?user_id=" +
      ...
      <div className={classes.card}>
          ...
          {permisions && (
            <div>
              <div className={classes.controls}>
                <div
                  onClick={showPeopleHandlerOpen}
                  onMouseEnter={showPeopleHandlerOpen}
                  onMouseLeave={showPeopleHandlerClose}
                  className={classes.ppl}
                >
                  People{" "}
                  <span className={classes.chevronBot}>
                    <FaChevronDown />
                  </span>
                </div>
              </div>
              {showPeopleHandler && (
                <div
                  ...
                  onMouseLeave={showPeopleHandlerClose}
                >
                  <InvitePeoplePopup onClick={inviteModalOpen} />
                </div>
              )}
            </div>
          )}
        ...
        {inviteFormHandler && (
          <InvitePeopleModal
            ...
            onCancel={inviteModalClose}
          />
        )}
        {newTasklist && <Backdrop onCancel={closeNewTasklistModal} />}
        {newTasklist && (
          <NewTasklistModal
            clickHande={moveStateByOne}
            onCancel={closeNewTasklistModal}
