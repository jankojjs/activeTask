...
function InvitePeopleForm(props) {
    ...
    return (
        <div>
            <h6 className={classes.headline}>Invite a person to this project as a member</h6>
            <div className={classes.grid}>
                <div>
                    <input ref={inputRef} className={classes.input} type='text' placeholder='Enter username'/>
                </div>
                <div>
                    <span className={classes.btns}>
                        <button className='alt' onClick={props.onCancel}>Close</button>
                    </span>
                    <span className={classes.btns}>
                        <button onClick={submitFormHandler} className='btn'>Invite</button>
                    </span>
                </div>
            </div>
        </div>
